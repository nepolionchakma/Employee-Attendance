...
export default function LocationGate({
  ...
  useEffect(() => {
    // The permission can also change from browser settings, so the modal state
    // is synced from it rather than only from the click handlers. 'prompt' is
    // left alone — the user opens the modal by clicking the locked button.
    const nextOpen = state === 'granted' ? false : state === 'denied' || state === 'unsupported' ? true : null
